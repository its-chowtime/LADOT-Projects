...
for x in range(len(list1)):
    ...
    print(list1[x].head())
    list1[x].to_csv('count_time_24hr.csv',mode='a',header=False)
'''
...
# new_df = birdla_data[['bikeid','lat','lon','time']]
# new_df.append(list2[0])
# print(new_df)
mds_data = pd.read_csv('mds_data_24hrs.csv')
print(mds_data)